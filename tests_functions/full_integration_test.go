...
func TestFullPipelineIntegration(t *testing.T) {
	// Create full pipeline: NumericConversion → Punctuation → Article → Case → Quotation
	...
	expected := `It was an historic race, LEWIS HAMILTON took pole position, scoring "30 points". It was 'amazing' to watch an incredible battle on track! the crowd SHOUTED: Go Lewis Go!! The Fans Waved Flags and an hero returned to the podium. WHAT an incredible moment for the sport!`
...
func TestComplexCombinations(t *testing.T) {
	...
	tests := []struct {
		...
		{"I met a (cap) honest man.", "I met An honest man.", "Article + Case"},
